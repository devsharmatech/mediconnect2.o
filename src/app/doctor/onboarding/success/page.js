...
export default function DoctorOnboardingSuccess() {
  return (
      ...
      >
        ...
        <div className="relative z-10 px-8 pt-10 pb-8">
          <div className="flex flex-col items-center text-center">
            ...
            >
              Your onboarding details have been submitted successfully. Our team
              will review your information and activate your doctor account
              shortly. You will receive an email notification once it is done.
            </motion.p>

            {/* Animated timeline dots */}
            <div className="flex items-center justify-center gap-3 mb-8 mt-2">
              {["Application received", "Under review", "Activation"].map(
                (label, idx) => (
                  <motion.div
                    key={label}
                    initial={{ opacity: 0, y: 10 }}
