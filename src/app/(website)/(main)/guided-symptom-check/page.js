import { FaHeartbeat, FaArrowLeft, FaClock } from "react-icons/fa";
    ...
    <div className="min-h-screen bg-[#F6F8FA]">
      ...
      <div className="bg-[#0067A1] px-6 py-10 md:px-10 md:py-12 text-center text-white">
        ...
        <p className="mt-2 text-sm md:text-base text-white/80 max-w-2xl mx-auto">
          A helpful tool to describe your concern before consulting a doctor.
        </p>
      </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-4">
              What is Guided Symptom Check?
            </h2>
            
            <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
              <p>
                The Guided Symptom Check helps you describe your health concern clearly before consulting a doctor. It asks simple questions about your symptoms to help you prepare for your consultation.
              </p>
              
              <p>
                This tool does not diagnose conditions or replace medical advice. It is meant to support - not substitute - doctor consultations.
              </p>

              <div className="bg-[#F6F8FA] rounded-xl p-4 mt-6">
                <p className="text-xs text-gray-500 mb-2 uppercase font-semibold">Important</p>
                <p className="text-sm text-gray-700">
                  If you are experiencing a medical emergency, please call emergency services (108/112) or visit the nearest hospital immediately.
                </p>
              </div>
            </div>
