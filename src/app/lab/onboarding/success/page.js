...
export default function LabOnboardingSuccess() {
  return (
          ...
          <div className="flex flex-col items-center text-center">
            ...
            >
              <div className="relative">
                ...
                >
                  <Beaker className="w-5 h-5 text-[#0067A1]" />
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              Thank you for registering your laboratory
            </motion.h1>
            ...
            >
              Your laboratory onboarding details have been submitted successfully.
